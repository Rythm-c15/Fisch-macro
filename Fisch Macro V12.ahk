...
Gui, Add, Edit, x170 y240 w100 vRestartDelay, 1000
...
SaveSettings:
    ...
    ; Done
	Gui, -AlwaysOnTop
	MsgBox, 0x40040, Saved, Settings saved successfully as "%SettingsFileName% !", 1
	Gui, +AlwaysOnTop
Return
...
LoadSettings:
	...
	; Done
	Gui, -AlwaysOnTop
	MsgBox, 0x40040, Loaded, Loaded %SettingsFileName% !, 1.5
	Gui, +AlwaysOnTop
	} else {
	Gui, -AlwaysOnTop
...
if (AutoLowerGraphics != true and AutoLowerGraphics != false)
	{
	msgbox, AutoLowerGraphics must be tick or unticked! Make sure you save before starting
	exitapp
	}
	
if (AutoEnableCameraMode != true and AutoEnableCameraMode != false)
	{
	msgbox, AutoEnableCameraMode must be checked or unchecked! Make sure you save before starting
	exitapp
	}
	
if (AutoZoomInCamera != true and AutoZoomInCamera != false)
	{
	msgbox, AutoZoomInCamera must be checked or unchecked! Make sure you save before starting
	exitapp
	}
	
if (AutoLookDownCamera != true and AutoLookDownCamera != false)
	{
	msgbox, AutoLookDownCamera must be checked or unchecked! Make sure you save before starting
	exitapp
	}
	
if (AutoBlurCamera != true and AutoBlurCamera != false)
	{
	msgbox, AutoBlurCamera must be checked or unchecked! Make sure you save before starting
	exitapp
	}
...
if !ErrorLevel {
    tooltip, %ProgressAreaPos%, %ProgressAreaX%, %ProgressAreaBottom%, 20
